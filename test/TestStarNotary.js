...
beforeEach(async() => {
    ...
    await contract('StarNotary', (accs) => {
        accounts = accs;
        owner = accounts[0];
    });
});
...
describe('all tests', () => {
    ...
    it('lets user1 get the funds after the sale', async() => {
        ...
        let balance = web3.utils.toWei('0.01', 'ether');

        await instance.createStar('starNum3', starId, {from:user1});
        await instance.putStarForSale(starId, starPrice, {from:user1});
        ...
        let val1 = Number(balanceOfUser1BeforeTransaction) + Number(starPrice);
        let val2 = Number(balanceOfUser1AfterTransaction);
